...
CHSJ_OilManagerDlg::CHSJ_OilManagerDlg(CWnd* pParent /*=NULL*/)
...
BEGIN_MESSAGE_MAP(CHSJ_OilManagerDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
// CHSJ_OilManagerDlg 消息处理程序

BOOL CHSJ_OilManagerDlg::OnInitDialog()
{
...
void CHSJ_OilManagerDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CHSJ_OilManagerDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CHSJ_OilManagerDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CHSJ_OilManagerDlg::OnBnClickedBtnOilDensity()
{
	if (m_OilDensityDlg)
	{
		m_OilDensityDlg->ShowWindow(SW_SHOWNORMAL);
		m_OilDensityDlg->SetFocus();
	}
}
